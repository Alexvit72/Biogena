...
(function (window, document, $, undefined) {
  ...
  var defaults = {
    ...
    btnTpl: {
      ...
      zoom: '<button data-fancybox-zoom class="fancybox-button fancybox-button--zoom" title="Увеличить">' +
...
$(document).ready(function(){
  ...
  $('.js-search-input').on('focus', function () {
    ...
    $('.js-search-wrap').addClass('is-open');
    $('.js-search-results').fadeIn();
  });

  $('.js-search-close').on('click', function () {
    $('body').removeClass('is-fixed');
    $('.js-search-bg').fadeOut();
    $('.js-search-block').removeClass('is-open');
    $('.js-search-wrap').removeClass('is-open');
    $('.js-search-results').fadeOut();
  });

  /* mobile */
  $('.js-search-input-mobile').on('focus', function () {
    $('body').addClass('is-fixed');
    $('.js-search-label-mobile').fadeOut();
    $('.js-search-close-mobile').fadeIn();
    $('.js-search-results-mobile').fadeIn();
  });

  $('.js-search-close-mobile').on('click', function () {
    $('body').removeClass('is-fixed');
    $('.js-search-label-mobile').fadeIn();
    $('.js-search-close-mobile').fadeOut();
    $('.js-search-results-mobile').fadeOut();
  });
});
$(function() {
    ...
    $('.js--contacts-toggle').on('click', function() {
        $('.contact-b__toggle').toggleClass('contact-b__toggle_active');
    ...
    $('.js--nav-toggle').on('click', function() {
        $('.nav-b__filter').stop(true,true).fadeToggle('fast');
    ...
    $(document).on('click', function(e){
        if ($(e.target).closest('.nav-b__toggle').length) return;
        $('.nav-b__item').removeClass('nav-b__item-toggle_active');
        $('.nav-b__toggle').stop(true,true).fadeOut('fast');
        e.stopPropagation();
    });

    $('.nav-b__links-toggle').on('click', function() {
        $parent_box = $(this).closest('.nav-b__item');
        $parent_box.siblings().removeClass('nav-b__item-toggle_active');
        $parent_box.siblings().find('.nav-b__toggle').stop(true,true).hide();
        $parent_box.find('.nav-b__toggle').stop(true,true).fadeToggle('fast');
